                ...
                <Header/>
                    <div>
                        <main>
                            ...
                            <br/>
                            <div className='text-start fw-bold' style={{ fontSize: '20px' }}> 회원 정보 </div>
                            <div className='pt-3'>
                            ...
                            <div className='d-flex justify-content-end'>
                                <Link to='/MemListInquiry' className='d-block'>
                                    <a className='btn btn-primary btn-outline-warning mx-1 my-5 p-2 btn-sm' href='#' role='button' style={{ background: 'orange' }}>회원삭제</a>
                                </Link>
                            </div>
                        </main>
                    </div>
